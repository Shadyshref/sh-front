...
},
{
    ...
    desc:"2-factor authentication and user-controlled encryption arejust a couple of the security features we allow to help secure your files."
},
{
    ...
    <div className='container'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-[100px] w-[865px] mx-auto max-w-full'>
          {items.map((item)=>(
            ...
            <Featuerbox key={item.title} title={item.title} icon={item.icon} desc={item.desc}/>
          ))}
        </div>
